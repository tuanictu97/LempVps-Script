...
import (
	...
	"io.github.tuanictu97/api/internal/inject"
	"io.github.tuanictu97/api/internal/middleware"
	"io.github.tuanictu97/api/internal/x/contextx"
	"io.github.tuanictu97/api/internal/x/utilx"
	"io.github.tuanictu97/api/pkg/errors"
	"io.github.tuanictu97/api/pkg/jwtauth"
	"io.github.tuanictu97/api/pkg/logger"

	_ "net/http/pprof"

	_ "io.github.tuanictu97/api/internal/swagger"
)
