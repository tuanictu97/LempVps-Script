#!/bin/bash
#######################################################
# LempVPS Script v2.0.4 for CentOS 6
# To install type: 
# curl -sO https://sys.ufaceplus/scripts/$(rpm -E %centos)/install && bash install
#######################################################
lempvps_version="2.0.4"
...
script_url="https://raw.githubusercontent.com/tuanictu97/LempVps-Script/master/scripts/6"
...
options=("PHP 8.1" "PHP 7.1" "PHP 7.0" "PHP 5.6")
PS3="$prompt"
select opt in "${options[@]}"; do 

    case "$REPLY" in
	1) php_version="8.1"; break;;
    2) php_version="7.1"; break;;
    3) php_version="7.0"; break;;
    4) php_version="5.6"; break;;
...
lempvps_version="$hocvps_version"
server_name="$server_name"
server_ip="$server_ip"
